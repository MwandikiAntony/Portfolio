  ...
  return (
    <section className="max-w-xl mx-auto space-y-6">
      ...
      <p className="text-gray-700 dark:text-gray-300">
        Whether you’re looking to collaborate on a new project, discuss a potential partnership,
        or just want to say hello — I’d love to hear from you. I’m currently open to freelance,
        contract, and full-time opportunities where I can help build impactful digital solutions.
      </p>
      <p className="text-gray-700 dark:text-gray-300">
